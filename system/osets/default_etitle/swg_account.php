...
function direct_output_oset_account_actives ()
{
	...
	if (empty ($direct_cachedata['output_users'])) { $f_return = "<p>".(direct_local_get ("account_actives_empty"))."</p>"; }
	else
	{
...
return ("<table class='pagetable' style='width:100%;table-layout:auto'>
